...
const ExpertFeed = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-dark-charcoal to-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <Link
            ...
            className="bg-purple-600 hover:bg-purple-700 text-soft-white px-6 py-3 rounded-lg text-sm font-medium transition-all shadow-lg hover:shadow-xl"
          >
            View Requests
          </Link>
        </div>
          ...
          <div>
            <div className="relative mb-8">
              <input
                ...
                className="w-full p-4 pl-12 bg-gray-800 text-white border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all"
                value={searchTerm}
