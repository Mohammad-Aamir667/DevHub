            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 text-gray-300">
              <div className="space-y-3">
                <div>
                  ...
                  <p className="font-medium">{expert.country || "Not specified"}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-400">City/State</p>
                  <p className="font-medium">{expert.city || "Not specified"}</p>
                </div>
              </div>
              <div className="space-y-3">
                <div>
                  <p className="text-sm text-gray-400">Postal Code</p>
                  <p className="font-medium">{expert.postalCode || "Not specified"}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-400">TAX ID</p>
                  <p className="font-medium">{expert.taxId || "Not specified"}</p>
                </div>
              </div>
            </div>
          </div>
